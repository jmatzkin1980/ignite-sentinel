...
Do not edit this ledger by hand. It is rebuilt by Sentinel from governed artifacts and exists so downstream agents can retrieve the current discovery state without treating memory as authority.
