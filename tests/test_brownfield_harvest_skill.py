"""IMP-194: brownfield-harvest skill presence, metadata, and contract anchors."""
...
SKILL = "sentinel-brownfield-harvest"
...
class BrownfieldHarvestSkillTests(unittest.TestCase):
    ...
    def test_contract_anchors_present(self):
        ...
        for anchor in (
            ...
            self.assertIn(anchor, text, f"brownfield-harvest skill missing contract anchor: {anchor!r}")
