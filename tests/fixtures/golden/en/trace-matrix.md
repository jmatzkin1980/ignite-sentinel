...
| `EPIC-001` | epic | `US-004` | user_story | contains | technical | active |
| `SPEC-001` | spec | `US-004` | user_story | decomposes_to | technical | active |
| `SPEC-U-004` | spec_unit | `US-004` | user_story | decomposes_to | technical | active |
| `US-004` | user_story | `AC-004` | acceptance_criteria | validated_by | quality | active |
| `EPIC-001` | epic | `US-005` | user_story | contains | technical | active |
| `SPEC-001` | spec | `US-005` | user_story | decomposes_to | technical | active |
| `SPEC-U-005` | spec_unit | `US-005` | user_story | decomposes_to | technical | active |
...
| `US-004` | user_story | technical | active | `workspaces/[PROJECT_ID]/04_backlog/US-004.md` |
| `AC-004` | acceptance_criteria | quality | active | `workspaces/[PROJECT_ID]/04_backlog/US-004.md` |
| `US-005` | user_story | technical | active | `workspaces/[PROJECT_ID]/04_backlog/US-005.md` |
