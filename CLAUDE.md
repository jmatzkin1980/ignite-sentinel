...
python -m sentinel /gaps | /annotate --source ANALYSIS.json | /challenge --source ANALYSIS.json | /scrutinize --source ANALYSIS.json | /assume --source ASSUMPTIONS.json | /resolve-gaps | /maturity | /brief | /compose --source FILE | /context-request
